              ...
              return (
                ...
                >
                  ...
                  <div className="relative mb-4 flex min-h-12 items-start justify-between gap-3">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl border border-neutral-200/80 bg-neutral-50 shadow-sm dark:border-neutral-700/50 dark:bg-neutral-900/50">
                      <cred.icon size={28} />
                    </div>
                    <span
