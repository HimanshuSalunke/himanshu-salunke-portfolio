...
export function buildLiveKnowledge(rootDir = process.cwd()) {
  ...
  const knowledge = {
    ...
    consultantRoles: liveContent.consultantRoles || [],
    achievements,
    credentials,
    skills,
...
export function buildNeuraSystemPrompt(knowledge, options = {}) {
  ...
  return [
    ...
    '- Story: storyTimeline. WorldQuant / BRAIN consultant: consultantRoles + storyTimeline. Skills: skills + skillCategories + techStackGroups.',
